...
. wmtheme/wmcolors.zsh wmtheme/generated_css/wmtheme-bright.css

cat <<EOF > build/windowmaker/STEPbrightmaker.themed/style
{
  ...
  IconBack = (mdgradient, "$BaseDark10", "$BaseDark50", "$BaseDark40", "$BaseDark50", "$BaseDark40", "$BaseDark50");
  IconTitleBack = "$Base"; 
  ...
  WorkspaceBack = (mdgradient, "$Base", "$BaseDark40", "$BaseDark30", "$BaseDark20", "$BaseDark30", "$BaseDark40");
}
EOF
